...
using oldMutual.Providers;
using oldMutual.Results;
...
namespace oldMutual.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        {
            //get email domain
            string EmailDomain =string.IsNullOrEmpty(model.Email)? null:model.Email.Split('@').Last();
            //validate email domain
            if (!string.IsNullOrEmpty(EmailDomain))
            {
                if (EmailDomain != "oldmutual.co.zw")
                {
                    return null;
                }
            }
        ...
        //{
        //    var identyR= await IdentityUser.
        //}
